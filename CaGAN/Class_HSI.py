...
def class_source(cuda, pred_src_main, source_num_classes):
	...
	source_features1 = torch.FloatTensor(pred_src_main.size()[0], source_num_classes, source_num_classes, 128, 128).cuda()
...
def class_target(cuda, pred_tar_main, target_num_classes):
	...
	target_features1 = torch.FloatTensor(pred_tar_main.size()[0], target_num_classes, target_num_classes, 128, 128).cuda()
